...
class AuthenticationController{
    public $model;
    public $error_url = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Public&function=error";
    public $base_url = "http://localhost/Tatvasoft-Project/Project/Helperland/";
    ...
    public function forgot_password_link(){
        if(isset($_POST)){
            ...
            if(count($result) > 0){
                ...
                $msg = "<h2>You are requested for password change.Please click on below link to change your password:</h2><h2><a href='$link' style='color:red' >Click here to change your password</a></h2>";
