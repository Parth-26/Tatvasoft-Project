...
$(document).ready(function () {
  ...
  $('.postal-check').click(function () {
    ...
    if (isPostalValid(zipcode)) {
      ...
      $.ajax({
        url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Service&function=postal",
        type: "POST",
        data: { postal: zipcode },
  ...
  $('.details-btn').click(function () {
    if (isCheckAddress()) {
      ...
      $.ajax({
        url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Service&function=isServiceAvailable",
        type : "POST",
