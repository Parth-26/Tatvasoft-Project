...
$(document).ready(function () {
  ...
  function adminData(limit = 5, page = 1) {
    ...
    // console.log(fdate);
    $.ajax({
      url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=adminData",
      type: "POST",
  ...
  $(document).on('click','#edit-reschedule',function(){
    ...
    $('.error').remove();
    $.ajax({
      url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=getAddress",
      type : "POST",
  ...
  $(document).on('keyup','#admin-edit-Postal',function(){
    ...
    $.ajax({
      url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=getCity",
      type : "POST",
      data : {postal: postal},
      success : function(result){
        const data = JSON.parse(result);
  ...
  $('#admin-edit-btn').click(function(){
    ...
    if(is_valid == true){
      $.ajax({
        url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=serviceReschedule",
        type : "POST",
  ...
  $(document).on('click','#refund',function(){
    ...
    if(is_valid == true){
      $.ajax({
        url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=refund",
        type : "POST",
  ...
  $(document).on('click','#cancleByAdmin',function(){
    ...
    // alert(serviceId);
    $.ajax({
      url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=cancleService",
      type : "POST",
      data : {serviceId: serviceId},
      success : function(result){
        const data = JSON.parse(result);
  ...
  $(document).on('click','.Is-Approved',function(){
    ...
    $.ajax({
      url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=userApproved",
      type : "POST",
