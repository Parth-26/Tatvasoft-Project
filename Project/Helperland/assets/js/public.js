...
$(document).ready(function () {
    ...
    $('#Register').click(function () {
        ...
        if (is_valid == true) {
            if(privacy == 1){
                $.ajax({
                    url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Authentication&function=user_signup",
                    type: "POST",
                    ...
                    success: function (result) {
                        ...
                        var alertMsg = "";
                        if (signup.status) {
                            window.location = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Public&function=home&parameter=login";
                        }
                        else {
    ...
    $('#signin').click(function () {
        ...
        if (is_valid == true) {
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Authentication&function=login",
                type: "POST",
                ...
                success: function (result) {
                    ...
                    if (loginData.status) {
                        if (loginData.UserTypeId == 1) {
                            window.location = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=customerDashboard&parameter=Dashboard";
                        } else if (loginData.UserTypeId == 2) {
                            window.location = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=ServicerDashboard&parameter=New";
                        } else {
                            window.location = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Admin&function=adminDashboard&parameter=srequest";
                        }
                    }
                    else {
    ...
    $('.logout-btn').click(function () {
        $.ajax({
            url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Authentication&function=logout",
            type: "POST",
            data: {},
            success: function (result) {
                var logoutData = JSON.parse(result);
                if (logoutData.status) {
                    window.location = "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Public&function=home&parameter=logout";
                }
            }
        });
    });
    ...
    $('#send').click(function () {
        ...
        if (is_valid == true) {
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Authentication&function=forgot_password_link",
                type: "POST",
                data: { email: email },
                success: function (result) {
    ...
    $('#save').click(function () {
        ...
        if (is_valid == true) {
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Authentication&function=forgot_password",
                type: "POST",
