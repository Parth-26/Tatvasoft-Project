...
$(document).ready(function () {
    ...
    function customerData(limit = 5, page = 1) {
        ...
        $.ajax({
            url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=customerData",
            type: "POST",
    ...
    function cancleService(serviceIdforCancle) {
        ...
        if(sid != 0){
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=serviceCancle",
                type: "POST",
    ...
    function rescheduleService(sIdforReschedule, rdate, rtime,starttime,workinghr) {
        ...
        if(sid != 0){
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=serviceReschedule",
                type: "POST",
    ...
    $(document).on('click','#rate-submit',function(){
        ...
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=giveRatting",
            type : "POST",
    ...
    function FavBlockSp(spid,action,status){
        ...
        var userId = $('#userdata').val();
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=favBlockSp",
            type : "POST",
    ...
    $('#save-sdetails').on('click',function(e){
        ...
        if(is_valid == true){
            $.ajax({
                url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=editSetting",
                type : 'POST',
    ...
    $(document).on('click','#editid',function(e){
        ...
        // alert(addresid);
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=getAddress",
            type : 'POST',
    ...
    $(document).on('keyup','#sapostal',function(){
        ...
        $.ajax({
          url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=getCity",
          type : "POST",
          data : {postal: postal},
          success : function(result){
            const data = JSON.parse(result);
    ...
    $('#add-edit-saddress').click(function(){
        ...
        if(is_valid == true){
            $.ajax({
                url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=addeditAddress",
                type : 'POST',
    ...
    $(document).on('click','#said',function(e){
        ...
        // alert(addresid);
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=addressDelete",
            type : "POST",
    ...
    $('#change-psw').click(function(){
        ...
        if(is_valid == true){
            $.ajax({
                url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Customer&function=changePassword",
                type : 'POST',
