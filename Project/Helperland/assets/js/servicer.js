...
$(document).ready(function () {
    ...
    $(document).on('click','#left-date',function(){
        ...
        ServicerData(limit = 5, page = 1, pstatus = "All", rstatus = "All");
    });
    ...
    function ServicerData(limit = 5, page = 1, pstatus = "All", rstatus = "All") {
        ...
        $.ajax({
            url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=servicerData",
            type: "POST",
    ...
    $('#Accept-button').click(function(e){
        ...
        $.ajax({
            url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=serviceAccept",
            type: "POST",
    ...
    function cancleService(serviceIdforCancle) {
        ...
        if(sid != 0){
            $.ajax({
                url: "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=serviceCancle",
                type: "POST",
    ...
    $('#table .tbody').on('click', function (e) {
        ...
        // alert(tabName);
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=serviceDetails",
            type : "POST",
    ...
    $('#complete-button').click(function(){
        ...
        // alert(customerId);
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=serviceComplete",
            type : "POST",
    ...
    function blockCustomer(cid,status){
        ...
        var limit = $('#number').val();
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=blockCustomer",
            type : "POST",
    ...
    $(document).on('keyup','#Postalcode',function(){
        ...
        $.ajax({
          url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=getCity",
          type : "POST",
          data : {postal: postal},
          success : function(result){
            const data = JSON.parse(result);
    ...
    $('#save-details').on('click',function(e){
        ...
        if(is_valid == true){
            $.ajax({
                url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=editSetting",
                type : 'POST',
    ...
    $("input[name='avtar']").click(function(){
        var avtar = $(this).val();
        $.ajax({
            url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=avtar",
            type : "POST",
    ...
    $('#change-psw').click(function(){
        ...
        if(is_valid == true){
            $.ajax({
                url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Servicer&function=changePassword",
                type : 'POST',
