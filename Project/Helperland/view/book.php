...
<head>
    ...
    <link rel="stylesheet" href="view/assets/css/book.css">
    <link rel="stylesheet" href="view/assets/css/modal.css">
...
<body onload="defaultDate()">
    ...
    ?></section>
        ...
        <section class="book-service-section">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="line"></div>
                <img src="view/assets/images/separator.png" alt="">
                <div class="line"></div>
            </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade " id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
                            ...
                            <div class="service-schedule">
                                <form action="<?= $base_url.'?controller=User&function=booking'?>" id="service-schedule-form" onsubmit="event.preventDefault();" method="POST">
                                    ...
                                    <div class="continue-btn pt-4">
                                        <button type="submit" class="btn form-control w-auto px-4 float-end Schedule-btn" id="Schedule-btn" >Continue</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="details" role="tabpanel" aria-labelledby="details-tab">
                            ...
                            <div class="details pt-3">
                                <form action="<?= $base_url.'?controller=User&function=booking'?>" onsubmit="event.preventDefault();" id="details-form" method="POST">
                                        ...
                                        <div id="add-new-address">
                                            <div class="card card-body">
                                                ...
                                                <div class="btn-wraper">
                                                    <button type="submit" class="save" id="na-save" >Save</button>
                                    ...
                                    <div class="continue-btn pt-4">
                                        <button type="submit" class="btn form-control w-auto px-4 float-end details-btn" onClick="showLoad()">Continue</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="payment-tab">
                            ...
                            <div class="payment-details">
                                <form action="<?= $base_url.'?controller=User&function=booking'?>" onsubmit="event.preventDefault();" method="POST">
                                    ...
                                    <div class="Accpeted-cards">
                                        ...
                                        <div class="d-flex">
                                            <img src="view/assets/images/credit-card-1.png" alt="">
                                            <img src="view/assets/images/credit-card-2.png" alt="">
                                            <img src="view/assets/images/credit-card-3.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="continue-btn pt-4">
                                        <button type="submit" class="btn form-control w-auto px-4 float-end payment-details-btn" >Complete
                                            Booking</button>
                                    </div>
                                </form>
                            </div>
                ...
                <div id="payment-div">
                    <div class="payment-tab">
                        <div class="payment-card">
                            ...
                            <div class="smily">
                                <img src="view/assets/images/smiley.png" alt=""> See what is always included
                            </div>
                        </div>
                        <div class="faq">
                            ...
                            <div class="accordion" id="accordion">
                                <div class="card1" id="heading-One">
                                    <p data-toggle="collapse" data-target="#collapse-One" class="qe">
                                        <img class="img" src="view/assets/images/drop-arrow.png" alt="">
                            ...
                            <div class="link"><a href="<?= $base_url.'?controller=User&function=faqs' ?>">For more help</a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="view/assets/js/nav.js"></script>
