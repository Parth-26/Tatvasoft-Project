...
$(document).ready(function () {
    ...
    $(".extra-service label").change(function(){
        ...
        if($(this).find('input[type=checkbox]').is(':checked')) {
          ...
          $(this).find('div img').attr("src","view/assets/images/"+$imgVal+"-green.png");
          ...
          $(this).find('div img').attr("src","view/assets/images/"+$imgVal+".png");
          selectHour -= 0.5;
          counter = -0.5;
        }
    ...
    function defaultExtra(){
      ...
      for(var i = 0; i < 5; i++){
        if(service[i].classList.contains('active')){
          ...
          $(service[i]).find('img').attr("src","view/assets/images/"+(i+1)+".png");
        }
      }
      index = [];
    }
    ...
    $('#na-save').click(function(){
      ...
      $.ajax({
        url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Service&function=addAddress",
        type : 'POST',
  ...
  $('.payment-details-btn').click(function(){
    ...
    if($('#terms').is(':checked')){
      $.ajax({
        url : "http://localhost/Tatvasoft-Project/Project/Helperland/?controller=Service&function=bookService",
        type : 'POST',
  ...
  function changeNavtabImg(){
    ...
    for(var i = 0; i < navitem.length; i++){
      if(navitem[i].classList.contains('fill') || navitem[i].classList.contains('active')){
        navitem[i].querySelector('img').src = "view/assets/images/"+whiteImg[i]+"-white.png";
      }
      else{
        navitem[i].querySelector('img').src = "view/assets/images/"+whiteImg[i]+".png";
      }
    }
  }
